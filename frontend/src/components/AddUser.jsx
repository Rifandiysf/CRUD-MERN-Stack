...
const AddUser = () => {
  ...
  return (
    <section className="relative flex flex-col justify-center items-center bg-Primary h-dvh">
        <form onSubmit={saveUser} className="bg-white rounded-lg p-[25px] max-sm:w-[97%] max-sm:p-[15px]">
            <div className="w-[45rem] max-sm:w-full">
                <h1 className="flex justify-center items-center mb-[50px] text-2xl font-bold max-sm:mb-[15px]">Add Student</h1>
                ...
                <button type="submit" className="w-full h-10 mt-5 rounded-md bg-Primary text-Secondary text-xl font-semibold">Submit</button>
            </div>
        </form>
